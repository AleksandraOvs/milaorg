...
function site_scripts(){
   ...
   // wp_enqueue_script ('js-accordion', get_stylesheet_directory_uri() . '/js/accordion.js', array('jquery'), null, true);
    ...
    wp_enqueue_style ('fonts-style', 'https://fonts.googleapis.com/css2?family=Nunito+Sans:opsz,wght@6..12,300;6..12,400;6..12,600&family=Roboto+Condensed:wght@400;600&display=swap');
